...
<section class="listings">
   ...
   <?php
      if(isset($_POST['search_box']) OR isset($_POST['search_btn'])){
         ...
         /* 
            html specialchars used to prevent XSS attacks by encoding HTM entities
            ENT_QUOTES ensures that both single and double quotes are encoded
            UTF is character encoding
         */
         $search_box =$search_box = htmlspecialchars($search_box, ENT_QUOTES, 'UTF-8');
