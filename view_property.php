...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i class="fa-solid fa-money-bill "></i><span><?= $fetch_property['price']; ?></span></p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>deposit amount : </i><span><span class="fa-solid fa-money-bill " style="margin-right: .5rem;"></span><?= $fetch_property['deposite']; ?></span></p>
